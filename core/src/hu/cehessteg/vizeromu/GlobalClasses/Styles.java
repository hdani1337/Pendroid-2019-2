...
public class Styles {
    ...
    public static Label.LabelStyle getCalibriLabelStyle() {
    ...
    public static Label.LabelStyle getConsolasLabelStyle() {
        Label.LabelStyle style;
        style = new com.badlogic.gdx.scenes.scene2d.ui.Label.LabelStyle();
        style.font = Assets.manager.get(Assets.CONSOLAS_FONT);
        style.fontColor = Color.WHITE;
        return style;
    }
