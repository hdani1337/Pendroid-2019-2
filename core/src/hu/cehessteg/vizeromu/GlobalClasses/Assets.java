...
public class Assets {
    ...
    public static final AssetDescriptor<Texture> AJTO = new AssetDescriptor<Texture>("ajto.png", Texture.class);
    public static final AssetDescriptor<Texture> FOLD = new AssetDescriptor<Texture>("fold.png", Texture.class);
